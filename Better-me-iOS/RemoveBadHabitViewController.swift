//
//  RemoveBadHabitViewController.swift
//  Better-me-iOS
//
...
protocol RemoveBadHabitViewDelegate: AnyObject {
    func didBadSelectRegister(habit: Habit)
}

class RemoveBadHabitViewController: UIViewController {
    @IBOutlet weak var titleTextField: UITextField!
    @IBOutlet weak var contentsTextView: UITextView!
    @IBOutlet weak var inviteTextField: UITextField!
    @IBOutlet weak var confirmButton: UIBarButtonItem!
    @IBOutlet weak var emojiTextField: UITextField!
    weak var delegate: RemoveBadHabitViewDelegate?
    ...
    @IBAction func tapConfirmButton(_ sender: UIBarButtonItem) {
        ...
        self.delegate?.didBadSelectRegister(habit: habit)
        self.navigationController?.popViewController(animated: true)
    }
    
}

extension RemoveBadHabitViewController: UITextViewDelegate {
...
extension RemoveBadHabitViewController: UITextFieldDelegate {
